...
document.querySelector('.select').addEventListener('change', function() { // Arrow function ()=> dose no work here* need to know why
...
function playRound(human, computer) {
    ...
    if (human === computer) {
        ...
        ( computer === 'rock' && human === 'scissors') ||       // Winning combinations for the human player
